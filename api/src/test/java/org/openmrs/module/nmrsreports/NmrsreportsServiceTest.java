 ...
 */
package org.openmrs.module.nmrsreports.api;
...
/**
 * This is a unit test, which verifies logic in NmrsreportsService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class NmrsreportsServiceTest {
	
	@InjectMocks
	NmrsreportsServiceImpl basicModuleService;
